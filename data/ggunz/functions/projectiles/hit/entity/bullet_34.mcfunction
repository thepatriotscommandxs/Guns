...
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=..3}] run effect give @s minecraft:instant_damage 1 2 true

execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=4..7}] run effect give @s minecraft:resistance 1 0 true
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=4..7}] run effect give @s minecraft:instant_damage 1 1 true

execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=8..11}] run effect give @s minecraft:resistance 1 0 true
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=8..11}] run effect give @s minecraft:instant_damage 1 2 true

execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=12..14}] run effect give @s minecraft:resistance 1 0 true
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=12..14}] run effect give @s minecraft:instant_damage 1 3 true
...
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=..3}] run effect give @s minecraft:resistance 1 2 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=..3}] run effect give @s minecraft:instant_health 1 2 true

execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=4..7}] run effect give @s minecraft:resistance 1 0 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=4..7}] run effect give @s minecraft:instant_health 1 1 true

execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=8..11}] run effect give @s minecraft:resistance 1 0 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=8..11}] run effect give @s minecraft:instant_health 1 2 true

execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=12..14}] run effect give @s minecraft:resistance 1 0 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=12..14}] run effect give @s minecraft:instant_health 1 3 true
