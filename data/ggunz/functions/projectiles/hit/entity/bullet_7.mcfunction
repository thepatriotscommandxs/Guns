...
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=4..7}] run effect give @s minecraft:resistance 1 2 true
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=4..7}] run effect give @s minecraft:instant_damage 1 2 true
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=8..11}] run effect give @s minecraft:resistance 1 1 true
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=8..11}] run effect give @s minecraft:instant_damage 1 2 true
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=12..15}] run effect give @s minecraft:resistance 1 2 true
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=12..15}] run effect give @s minecraft:instant_damage 1 4 true
execute if entity @s[type=!#ggunz:undead,scores={shotgunHeadshot=16..}] run effect give @s minecraft:instant_damage 1 4 true
execute if entity @s[type=end_crystal] run summon arrow ~ ~3 ~ {Motion:[0.0,-5.0,0.0],damage:0}
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=..3}] run effect give @s minecraft:instant_health 1 0 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=4..7}] run effect give @s minecraft:resistance 1 2 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=4..7}] run effect give @s minecraft:instant_health 1 2 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=8..11}] run effect give @s minecraft:resistance 1 1 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=8..11}] run effect give @s minecraft:instant_health 1 2 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=12..15}] run effect give @s minecraft:resistance 1 2 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=12..15}] run effect give @s minecraft:instant_health 1 4 true
execute if entity @s[type=#ggunz:undead,scores={shotgunHeadshot=16..}] run effect give @s minecraft:instant_health 1 4 true
