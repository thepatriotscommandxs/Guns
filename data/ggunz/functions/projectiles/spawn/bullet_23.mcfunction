...
execute if score GLOBAL bloom matches 1 run function ggunz:recoil_types/bloom/bullet_23
execute if score GLOBAL spray matches 1 run function ggunz:recoil_types/sprays/bullet_23
