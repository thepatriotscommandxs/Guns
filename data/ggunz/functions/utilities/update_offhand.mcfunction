...
data modify block ~ -64 ~ Items[{Slot:0b}].tag.display.Name set from entity @s Inventory[{Slot:-106b}].tag.display.Name
data modify block ~ -64 ~ Items[{Slot:0b}].tag.Enchantments set from entity @s Inventory[{Slot:-106b}].tag.Enchantments
...
loot replace entity @s weapon.offhand mine ~ -64 ~ air{drop_contents:1b}
